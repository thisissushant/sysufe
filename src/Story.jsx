...
const appSetting = {
  databaseURL: "https://assignment-sysu-default-rtdb.firebaseio.com/",
};
        ...
        <section className="section-2">
          <div className="section-2-head">
            ...
            <div className="looking">
              ...
              {/* Fix the sort option under the  - "what are you looking for section" instead of the right most positioningPositioning of sort */}
